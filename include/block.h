...
#define PROPERTIES(_) \
    ...
    _(border_top,            8,    PROP_I3BAR | PROP_NUMBER)  \
    _(border_bottom,         8,    PROP_I3BAR | PROP_NUMBER) \
	_(border_left,           8,    PROP_I3BAR | PROP_NUMBER) \
	_(border_right,          8,    PROP_I3BAR | PROP_NUMBER) \
	_(min_width,             1024, PROP_I3BAR | PROP_NUMBER) \
